...
1. Clone this project as well as the [stage-2 project](https://github.com/smlovin2/mws-restaurant-stage-2)
...
3. Start up external server from stage-2. Make sure you have node.js, npm and sails.js installed (see Readme from stage-2 for instructions). After those are installed open termial in stage-2 folder and run `node server` to start up the external server.
